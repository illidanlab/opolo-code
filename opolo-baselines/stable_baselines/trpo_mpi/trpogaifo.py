...
class TRPOGAIFO(ActorCriticRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, timesteps_per_batch=1024, max_kl=0.01, cg_iters=10, lam=0.98,
        ...
        super(TRPOGAIFO, self).__init__(policy=policy, env=env, verbose=verbose, requires_vec_env=False,
        ...
        self.mi_gradient_steps = 100
        self.mi_learning_rate = 3e-4
                ...
                while True:
                    ...
                    if self.using_gail:
                        ...
                        self.discriminator.train_onpolicy_discriminator(
                            writer, logger, self.d_gradient_steps, self.d_learning_rate, self.d_batch_size, self.teacher_buffer, seg, self.num_timesteps, self.sess, self.d_adam, self.nworkers)
