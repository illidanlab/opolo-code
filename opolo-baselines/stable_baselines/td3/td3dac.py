...
class TD3DAC(OffPolicyRLModel):
    """
    Discriminator Actor Critic based on TD3.
    ...
    def __init__(self, policy, env, gamma=0.99, learning_rate=3e-4, buffer_size=50000, demo_buffer_size=1e4,
        ...
        super(TD3DAC, self).__init__(policy=policy, env=env, replay_buffer=None, verbose=verbose,
    ...
    def get_imitate_reward(self, batch_obs, batch_actions, batch_next_obs, batch_rewards, batch_dones):
        ...
        rewards = self.discriminator.get_reward(batch_obs, batch_actions, sess=self.sess)
        return rewards
